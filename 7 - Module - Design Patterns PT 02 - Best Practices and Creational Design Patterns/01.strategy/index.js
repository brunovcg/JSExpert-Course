...
const postgresConnectionString = "postgres://erickwendel:senha0001@localhost:5434/heroes"
const postgresContext = new ContextStrategy(new PostgresStrategy(postgresConnectionString))
await postgresContext.connect()

const mongoDBConnectionString = "mongodb_js_expert://erickwendel:senhaadmin@localhost:27017/heroes"
